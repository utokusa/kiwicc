...
assert() {
  ...
  echo "$input" | qemu-riscv64 ./kiwicc - -fno-pic -o tmp.s
...
assert 8 'int main() { return add(1, 2) + 5; }'
...
assert 32 'int main() { int a[8]; return sizeof(a);}'
...
assert 10 'int x=10; int main() { return x; }'
...
assert 1 'int x[] = {0, 1, 2}; int main() {return x[1];}'
